...
// ApiAtlasClusterV15ComputeAutoScalingGCPManual struct for ApiAtlasClusterV15ComputeAutoScalingGCPManual
type ApiAtlasClusterV15ComputeAutoScalingGCPManual struct {
...
func NewApiAtlasClusterV15ComputeAutoScalingGCPManual() *ApiAtlasClusterV15ComputeAutoScalingGCPManual {
	this := ApiAtlasClusterV15ComputeAutoScalingGCPManual{}
	return &this
}
...
func (o ApiAtlasClusterV15ComputeAutoScalingGCPManual) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasClusterV15ComputeAutoScalingGCPManual struct {
	value *ApiAtlasClusterV15ComputeAutoScalingGCPManual
	isSet bool
}

func (v NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) Get() *ApiAtlasClusterV15ComputeAutoScalingGCPManual {
	return v.value
}

func (v *NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) Set(val *ApiAtlasClusterV15ComputeAutoScalingGCPManual) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasClusterV15ComputeAutoScalingGCPManual(val *ApiAtlasClusterV15ComputeAutoScalingGCPManual) *NullableApiAtlasClusterV15ComputeAutoScalingGCPManual {
	return &NullableApiAtlasClusterV15ComputeAutoScalingGCPManual{value: val, isSet: true}
}

func (v NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasClusterV15ComputeAutoScalingGCPManual) UnmarshalJSON(src []byte) error {
	v.isSet = true
