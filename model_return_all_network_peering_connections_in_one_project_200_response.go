...
func (dst *ReturnAllNetworkPeeringConnectionsInOneProject200Response) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.PaginatedAWSPeerVpcView)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.PaginatedAzurePeerNetworkView)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.PaginatedGCPPeerVpcView)
	if err == nil {
