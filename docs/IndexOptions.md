...
------------ | ------------- | ------------- | -------------
**Var2dsphereIndexVersion** | **int32** | Index version number applied to the 2dsphere index. MongoDB 3.2 and later use version 3. Use this option to override the default version number. This option applies to the **2dsphere** index type only. | [default to 3]
...
**ExpireAfterSeconds** | Pointer to **int32** | Number of seconds that MongoDB retains documents in a Time To Live (TTL) index. | [optional] 
...
**Max** | Pointer to **int32** | Upper inclusive boundary to limit the longitude and latitude values. This option applies to the 2d index type only. | [optional] [default to 180]
**Min** | Pointer to **int32** | Lower inclusive boundary to limit the longitude and latitude values. This option applies to the 2d index type only. | [optional] [default to -180]
...
**TextIndexVersion** | Pointer to **int32** | Version applied to this text index. MongoDB 3.2 and later use version &#x60;3&#x60;. Use this option to override the default version number. This option applies to the **text** index type only. | [optional] [default to 3]
