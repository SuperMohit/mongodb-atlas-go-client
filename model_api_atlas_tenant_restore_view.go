...
// ApiAtlasTenantRestoreView struct for ApiAtlasTenantRestoreView
type ApiAtlasTenantRestoreView struct {
...
func NewApiAtlasTenantRestoreView(links []Link, snapshotId string, targetDeploymentItemName string) *ApiAtlasTenantRestoreView {
	this := ApiAtlasTenantRestoreView{}
	this.Links = links
...
func (o ApiAtlasTenantRestoreView) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasTenantRestoreView struct {
	value *ApiAtlasTenantRestoreView
	isSet bool
}

func (v NullableApiAtlasTenantRestoreView) Get() *ApiAtlasTenantRestoreView {
	return v.value
}

func (v *NullableApiAtlasTenantRestoreView) Set(val *ApiAtlasTenantRestoreView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasTenantRestoreView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasTenantRestoreView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasTenantRestoreView(val *ApiAtlasTenantRestoreView) *NullableApiAtlasTenantRestoreView {
	return &NullableApiAtlasTenantRestoreView{value: val, isSet: true}
}

func (v NullableApiAtlasTenantRestoreView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasTenantRestoreView) UnmarshalJSON(src []byte) error {
	v.isSet = true
