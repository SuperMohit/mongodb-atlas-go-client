...
// ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute Collection of settings that configures how a cluster might scale its cluster tier and whether the cluster can scale down. Cluster tier auto-scaling is unavailable for clusters using Low CPU or NVME storage classes.
type ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute struct {
...
func NewApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute() *ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute {
	this := ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute{}
	return &this
}
...
func (o ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute struct {
	value *ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute
	isSet bool
}

func (v NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) Get() *ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute {
	return v.value
}

func (v *NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) Set(val *ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute(val *ApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) *NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute {
	return &NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute{value: val, isSet: true}
}

func (v NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasGCPProviderSettingsViewManualAllOfAutoScalingCompute) UnmarshalJSON(src []byte) error {
	v.isSet = true
