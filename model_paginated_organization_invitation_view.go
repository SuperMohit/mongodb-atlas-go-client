...
// PaginatedOrganizationInvitationView struct for PaginatedOrganizationInvitationView
type PaginatedOrganizationInvitationView struct {
	// List of one or more Uniform Resource Locators (URLs) that point to API sub-resources, related API resources, or both. RFC 5988 outlines these relationships.
	Links []Link `json:"links"`
	// List of returned documents that MongoDB Cloud providers when completing this request.
	Results []ApiOrganizationInvitationView `json:"results"`
...
func NewPaginatedOrganizationInvitationView(links []Link, results []ApiOrganizationInvitationView, totalCount int32) *PaginatedOrganizationInvitationView {
	this := PaginatedOrganizationInvitationView{}
	this.Links = links
...
func (o *PaginatedOrganizationInvitationView) GetResults() []ApiOrganizationInvitationView {
	if o == nil {
		var ret []ApiOrganizationInvitationView
		return ret
	}
...
func (o PaginatedOrganizationInvitationView) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedOrganizationInvitationView struct {
	value *PaginatedOrganizationInvitationView
	isSet bool
}

func (v NullablePaginatedOrganizationInvitationView) Get() *PaginatedOrganizationInvitationView {
	return v.value
}

func (v *NullablePaginatedOrganizationInvitationView) Set(val *PaginatedOrganizationInvitationView) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedOrganizationInvitationView) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedOrganizationInvitationView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedOrganizationInvitationView(val *PaginatedOrganizationInvitationView) *NullablePaginatedOrganizationInvitationView {
	return &NullablePaginatedOrganizationInvitationView{value: val, isSet: true}
}

func (v NullablePaginatedOrganizationInvitationView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedOrganizationInvitationView) UnmarshalJSON(src []byte) error {
	v.isSet = true
