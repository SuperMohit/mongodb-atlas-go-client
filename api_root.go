...
func (r ApiGetSystemStatusRequest) Envelope(envelope bool) ApiGetSystemStatusRequest {
	r.envelope = &envelope
	return r
}

// Flag that indicates whether the response body should be in the prettyprint format.
func (r ApiGetSystemStatusRequest) Pretty(pretty bool) ApiGetSystemStatusRequest {
	r.pretty = &pretty
	return r
}

func (r ApiGetSystemStatusRequest) Execute() (*ApiSystemStatusView, *http.Response, error) {
...
*/
func (a *RootApiService) GetSystemStatus(ctx context.Context) ApiGetSystemStatusRequest {
	return ApiGetSystemStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RootApiService) GetSystemStatusExecute(r ApiGetSystemStatusRequest) (*ApiSystemStatusView, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/atlas/v1.0"
