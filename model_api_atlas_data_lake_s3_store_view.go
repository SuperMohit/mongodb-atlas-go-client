...
// ApiAtlasDataLakeS3StoreView struct for ApiAtlasDataLakeS3StoreView
type ApiAtlasDataLakeS3StoreView struct {
...
func NewApiAtlasDataLakeS3StoreView(provider string) *ApiAtlasDataLakeS3StoreView {
	this := ApiAtlasDataLakeS3StoreView{}
...
func (o ApiAtlasDataLakeS3StoreView) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasDataLakeS3StoreView struct {
	value *ApiAtlasDataLakeS3StoreView
	isSet bool
}

func (v NullableApiAtlasDataLakeS3StoreView) Get() *ApiAtlasDataLakeS3StoreView {
	return v.value
}

func (v *NullableApiAtlasDataLakeS3StoreView) Set(val *ApiAtlasDataLakeS3StoreView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasDataLakeS3StoreView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasDataLakeS3StoreView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasDataLakeS3StoreView(val *ApiAtlasDataLakeS3StoreView) *NullableApiAtlasDataLakeS3StoreView {
	return &NullableApiAtlasDataLakeS3StoreView{value: val, isSet: true}
}

func (v NullableApiAtlasDataLakeS3StoreView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasDataLakeS3StoreView) UnmarshalJSON(src []byte) error {
	v.isSet = true
