...
// ApiAtlasClusterDescriptionV15View struct for ApiAtlasClusterDescriptionV15View
type ApiAtlasClusterDescriptionV15View struct {
	...
	ReplicationSpecs []ApiAtlasReplicationSpecsV15Manual `json:"replicationSpecs,omitempty"`
...
func NewApiAtlasClusterDescriptionV15View(links []Link) *ApiAtlasClusterDescriptionV15View {
	this := ApiAtlasClusterDescriptionV15View{}
...
func (o *ApiAtlasClusterDescriptionV15View) GetReplicationSpecs() []ApiAtlasReplicationSpecsV15Manual {
	if o == nil || isNil(o.ReplicationSpecs) {
		var ret []ApiAtlasReplicationSpecsV15Manual
		return ret
	}
...
// SetReplicationSpecs gets a reference to the given []ApiAtlasReplicationSpecsV15Manual and assigns it to the ReplicationSpecs field.
...
func (o ApiAtlasClusterDescriptionV15View) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasClusterDescriptionV15View struct {
	value *ApiAtlasClusterDescriptionV15View
	isSet bool
}

func (v NullableApiAtlasClusterDescriptionV15View) Get() *ApiAtlasClusterDescriptionV15View {
	return v.value
}

func (v *NullableApiAtlasClusterDescriptionV15View) Set(val *ApiAtlasClusterDescriptionV15View) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasClusterDescriptionV15View) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasClusterDescriptionV15View) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasClusterDescriptionV15View(val *ApiAtlasClusterDescriptionV15View) *NullableApiAtlasClusterDescriptionV15View {
	return &NullableApiAtlasClusterDescriptionV15View{value: val, isSet: true}
}

func (v NullableApiAtlasClusterDescriptionV15View) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasClusterDescriptionV15View) UnmarshalJSON(src []byte) error {
	v.isSet = true
