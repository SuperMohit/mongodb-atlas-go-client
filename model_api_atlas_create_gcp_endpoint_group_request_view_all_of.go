...
// ApiAtlasCreateGCPEndpointGroupRequestViewAllOf struct for ApiAtlasCreateGCPEndpointGroupRequestViewAllOf
type ApiAtlasCreateGCPEndpointGroupRequestViewAllOf struct {
...
func NewApiAtlasCreateGCPEndpointGroupRequestViewAllOf() *ApiAtlasCreateGCPEndpointGroupRequestViewAllOf {
	this := ApiAtlasCreateGCPEndpointGroupRequestViewAllOf{}
	return &this
}
...
func (o ApiAtlasCreateGCPEndpointGroupRequestViewAllOf) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf struct {
	value *ApiAtlasCreateGCPEndpointGroupRequestViewAllOf
	isSet bool
}

func (v NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) Get() *ApiAtlasCreateGCPEndpointGroupRequestViewAllOf {
	return v.value
}

func (v *NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) Set(val *ApiAtlasCreateGCPEndpointGroupRequestViewAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf(val *ApiAtlasCreateGCPEndpointGroupRequestViewAllOf) *NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf {
	return &NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf{value: val, isSet: true}
}

func (v NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasCreateGCPEndpointGroupRequestViewAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
