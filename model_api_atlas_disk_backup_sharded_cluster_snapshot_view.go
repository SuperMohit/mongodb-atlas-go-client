...
// ApiAtlasDiskBackupShardedClusterSnapshotView Details of the sharded cluster snapshot that MongoDB Cloud created.
type ApiAtlasDiskBackupShardedClusterSnapshotView struct {
	...
	Members []ApiAtlasDiskBackupShardedClusterSnapshotMemberView `json:"members,omitempty"`
...
func NewApiAtlasDiskBackupShardedClusterSnapshotView(links []Link) *ApiAtlasDiskBackupShardedClusterSnapshotView {
	this := ApiAtlasDiskBackupShardedClusterSnapshotView{}
	this.Links = links
	return &this
}
...
func (o *ApiAtlasDiskBackupShardedClusterSnapshotView) GetMembers() []ApiAtlasDiskBackupShardedClusterSnapshotMemberView {
	if o == nil || isNil(o.Members) {
		var ret []ApiAtlasDiskBackupShardedClusterSnapshotMemberView
		return ret
	}
	return o.Members
}
...
// SetMembers gets a reference to the given []ApiAtlasDiskBackupShardedClusterSnapshotMemberView and assigns it to the Members field.
...
func (o ApiAtlasDiskBackupShardedClusterSnapshotView) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasDiskBackupShardedClusterSnapshotView struct {
	value *ApiAtlasDiskBackupShardedClusterSnapshotView
	isSet bool
}

func (v NullableApiAtlasDiskBackupShardedClusterSnapshotView) Get() *ApiAtlasDiskBackupShardedClusterSnapshotView {
	return v.value
}

func (v *NullableApiAtlasDiskBackupShardedClusterSnapshotView) Set(val *ApiAtlasDiskBackupShardedClusterSnapshotView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasDiskBackupShardedClusterSnapshotView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasDiskBackupShardedClusterSnapshotView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasDiskBackupShardedClusterSnapshotView(val *ApiAtlasDiskBackupShardedClusterSnapshotView) *NullableApiAtlasDiskBackupShardedClusterSnapshotView {
	return &NullableApiAtlasDiskBackupShardedClusterSnapshotView{value: val, isSet: true}
}

func (v NullableApiAtlasDiskBackupShardedClusterSnapshotView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasDiskBackupShardedClusterSnapshotView) UnmarshalJSON(src []byte) error {
	v.isSet = true
