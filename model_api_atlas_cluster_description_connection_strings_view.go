...
// ApiAtlasClusterDescriptionConnectionStringsView Collection of Uniform Resource Locators that point to the MongoDB database.
type ApiAtlasClusterDescriptionConnectionStringsView struct {
	...
	PrivateEndpoint []ApiAtlasClusterDescriptionConnectionStringsPrivateEndpointView `json:"privateEndpoint,omitempty"`
...
func NewApiAtlasClusterDescriptionConnectionStringsView() *ApiAtlasClusterDescriptionConnectionStringsView {
	this := ApiAtlasClusterDescriptionConnectionStringsView{}
	return &this
}
...
func (o *ApiAtlasClusterDescriptionConnectionStringsView) GetPrivateEndpoint() []ApiAtlasClusterDescriptionConnectionStringsPrivateEndpointView {
	if o == nil || isNil(o.PrivateEndpoint) {
		var ret []ApiAtlasClusterDescriptionConnectionStringsPrivateEndpointView
		return ret
	}
...
// SetPrivateEndpoint gets a reference to the given []ApiAtlasClusterDescriptionConnectionStringsPrivateEndpointView and assigns it to the PrivateEndpoint field.
...
func (o ApiAtlasClusterDescriptionConnectionStringsView) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasClusterDescriptionConnectionStringsView struct {
	value *ApiAtlasClusterDescriptionConnectionStringsView
	isSet bool
}

func (v NullableApiAtlasClusterDescriptionConnectionStringsView) Get() *ApiAtlasClusterDescriptionConnectionStringsView {
	return v.value
}

func (v *NullableApiAtlasClusterDescriptionConnectionStringsView) Set(val *ApiAtlasClusterDescriptionConnectionStringsView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasClusterDescriptionConnectionStringsView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasClusterDescriptionConnectionStringsView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasClusterDescriptionConnectionStringsView(val *ApiAtlasClusterDescriptionConnectionStringsView) *NullableApiAtlasClusterDescriptionConnectionStringsView {
	return &NullableApiAtlasClusterDescriptionConnectionStringsView{value: val, isSet: true}
}

func (v NullableApiAtlasClusterDescriptionConnectionStringsView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasClusterDescriptionConnectionStringsView) UnmarshalJSON(src []byte) error {
	v.isSet = true
