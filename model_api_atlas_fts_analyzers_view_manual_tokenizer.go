...
func (dst *ApiAtlasFTSAnalyzersViewManualTokenizer) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.TokenizeredgeGram)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.Tokenizerkeyword)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.TokenizernGram)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.TokenizerregexCaptureGroup)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.TokenizerregexSplit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.Tokenizerstandard)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.TokenizeruaxUrlEmail)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.Tokenizerwhitespace)
	if err == nil {
