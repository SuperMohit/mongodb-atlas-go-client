...
// ApiAtlasAWSPeerVpcView Group of Network Peering connection settings.
type ApiAtlasAWSPeerVpcView struct {
...
func (o ApiAtlasAWSPeerVpcView) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasAWSPeerVpcView struct {
	value *ApiAtlasAWSPeerVpcView
	isSet bool
}

func (v NullableApiAtlasAWSPeerVpcView) Get() *ApiAtlasAWSPeerVpcView {
	return v.value
}

func (v *NullableApiAtlasAWSPeerVpcView) Set(val *ApiAtlasAWSPeerVpcView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasAWSPeerVpcView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasAWSPeerVpcView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasAWSPeerVpcView(val *ApiAtlasAWSPeerVpcView) *NullableApiAtlasAWSPeerVpcView {
	return &NullableApiAtlasAWSPeerVpcView{value: val, isSet: true}
}

func (v NullableApiAtlasAWSPeerVpcView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasAWSPeerVpcView) UnmarshalJSON(src []byte) error {
	v.isSet = true
