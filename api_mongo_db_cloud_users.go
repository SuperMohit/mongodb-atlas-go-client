...
type ApiCreateOneCloudUserRequest struct {
	ctx context.Context
	ApiService *MongoDBCloudUsersApiService
...
func (r ApiCreateOneCloudUserRequest) ApiAppUserView(apiAppUserView ApiAppUserView) ApiCreateOneCloudUserRequest {
	r.apiAppUserView = &apiAppUserView
	return r
}

// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r ApiCreateOneCloudUserRequest) Envelope(envelope bool) ApiCreateOneCloudUserRequest {
	r.envelope = &envelope
	return r
}

// Flag that indicates whether the response body should be in the prettyprint format.
func (r ApiCreateOneCloudUserRequest) Pretty(pretty bool) ApiCreateOneCloudUserRequest {
	r.pretty = &pretty
	return r
}

func (r ApiCreateOneCloudUserRequest) Execute() (*ApiAppUserView, *http.Response, error) {
...
Creates one MongoDB Cloud user account. A MongoDB Cloud user account only grants access to the MongoDB Cloud application. To grant database access, create a database user. To use this resource, the requesting API Key can have any role. This resource doesn't require the API Key to have an Access List.
 ...
 @return ApiCreateOneCloudUserRequest
*/
func (a *MongoDBCloudUsersApiService) CreateOneCloudUser(ctx context.Context) ApiCreateOneCloudUserRequest {
	return ApiCreateOneCloudUserRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MongoDBCloudUsersApiService) CreateOneCloudUserExecute(r ApiCreateOneCloudUserRequest) (*ApiAppUserView, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/atlas/v1.0/users"
...
type ApiReturnOneCloudUserUsingItsIdRequest struct {
	ctx context.Context
	ApiService *MongoDBCloudUsersApiService
	userId string
	envelope *bool
...
// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r ApiReturnOneCloudUserUsingItsIdRequest) Envelope(envelope bool) ApiReturnOneCloudUserUsingItsIdRequest {
	r.envelope = &envelope
	return r
}

// Flag that indicates whether the response body should be in the prettyprint format.
func (r ApiReturnOneCloudUserUsingItsIdRequest) Pretty(pretty bool) ApiReturnOneCloudUserUsingItsIdRequest {
	r.pretty = &pretty
	return r
}

func (r ApiReturnOneCloudUserUsingItsIdRequest) Execute() (*ApiAppUserView, *http.Response, error) {
...
Returns the details for one MongoDB Cloud user account with the specified unique identifier for the user. To use this resource, the requesting API Key can have any role. This resource doesn't require the API Key to have an Access List.
 ...
 @return ApiReturnOneCloudUserUsingItsIdRequest
*/
func (a *MongoDBCloudUsersApiService) ReturnOneCloudUserUsingItsId(ctx context.Context, userId string) ApiReturnOneCloudUserUsingItsIdRequest {
	return ApiReturnOneCloudUserUsingItsIdRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return ApiAppUserView
func (a *MongoDBCloudUsersApiService) ReturnOneCloudUserUsingItsIdExecute(r ApiReturnOneCloudUserUsingItsIdRequest) (*ApiAppUserView, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/atlas/v1.0/users/{userId}"
...
type ApiReturnOneCloudUserUsingItsUsernameRequest struct {
	ctx context.Context
	ApiService *MongoDBCloudUsersApiService
	userName string
	envelope *bool
...
// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r ApiReturnOneCloudUserUsingItsUsernameRequest) Envelope(envelope bool) ApiReturnOneCloudUserUsingItsUsernameRequest {
	r.envelope = &envelope
	return r
}

// Flag that indicates whether the response body should be in the prettyprint format.
func (r ApiReturnOneCloudUserUsingItsUsernameRequest) Pretty(pretty bool) ApiReturnOneCloudUserUsingItsUsernameRequest {
	r.pretty = &pretty
	return r
}

func (r ApiReturnOneCloudUserUsingItsUsernameRequest) Execute() (*ApiAppUserView, *http.Response, error) {
...
Returns the details for one MongoDB Cloud user account with the specified username. To use this resource, the requesting API Key can have any role. This resource doesn't require the API Key to have an Access List.
 ...
 @return ApiReturnOneCloudUserUsingItsUsernameRequest
*/
func (a *MongoDBCloudUsersApiService) ReturnOneCloudUserUsingItsUsername(ctx context.Context, userName string) ApiReturnOneCloudUserUsingItsUsernameRequest {
	return ApiReturnOneCloudUserUsingItsUsernameRequest{
		ApiService: a,
		ctx: ctx,
		userName: userName,
...
// Execute executes the request
//  @return ApiAppUserView
func (a *MongoDBCloudUsersApiService) ReturnOneCloudUserUsingItsUsernameExecute(r ApiReturnOneCloudUserUsingItsUsernameRequest) (*ApiAppUserView, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/atlas/v1.0/users/byName/{userName}"
